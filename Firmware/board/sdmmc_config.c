...
__attribute__((section(".ocram"))) static uint32_t s_sdmmcHostDmaBuffer[BOARD_SDMMC_HOST_DMA_DESCRIPTOR_BUFFER_SIZE] __attribute__((aligned(SDMMCHOST_DMA_DESCRIPTOR_BUFFER_ALIGN_SIZE)));
